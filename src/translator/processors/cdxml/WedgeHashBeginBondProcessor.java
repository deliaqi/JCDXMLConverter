...
public class WedgeHashBeginBondProcessor extends BondProcessor {
    
    public WedgeHashBeginBondProcessor() {
    }
    ...
    protected void process() {
        ...
        GeometricLine bondLine = new GeometricLine("bondLine", begin, end, getLineWidth(), wedgedWidth);
        ...
        if(crossBonds != null){
            ...
            resultingConfiguration =
                    new CompositeShapeConfiguration("Wedged Hash Begin Bond", innerShapes);
        }
